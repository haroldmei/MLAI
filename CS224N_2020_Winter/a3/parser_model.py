...
class ParserModel(nn.Module):
    ...
    def forward(self, w):
        ...
        print(logits)the layers of the network)
        ...
        h = torch.mm(embeddings, self.embed_to_hidden_weight)  + self.embed_to_hidden_bias
        h_dropout = self.dropout(nn.functional.relu_(h))
