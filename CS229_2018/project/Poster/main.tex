...
\begin{itemize}
\item Word embeddings benchmarks for GloVe, LSTM Baseline and Seq2seq model. LSTM baseline model is roughly at the level of distributional method; s2s model shows very limited evidence of such capability.  (https://github.com/kudkudak/word-embeddings-benchmarks):
\end{itemize}
\begin{center}
...
\begin{itemize}
\compresslist
\item LSTM baseline vectors tend to cluster in feature space. Need to train from a broader source.
\item Glove makes use of feature space more efficiently, grasp more sutle meaning of words.
\end{itemize}
\vspace*{-0.2cm}
